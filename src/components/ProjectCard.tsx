...
export function ProjectCard({ project }: { project: Project }) {
  return (
    <li
      data-reveal
      data-cursor-target
      className="flex min-h-[max(17rem,42vh)] w-[min(85vw,20rem)] shrink-0 snap-center flex-col rounded-xl border border-hairline bg-panel/40 p-5 transition-[transform,box-shadow,border-color] duration-300 hover:-translate-y-1 hover:border-dwarf/50 hover:shadow-[0_0_24px_-6px_rgba(169,200,255,0.45)] focus-within:-translate-y-1 focus-within:border-dwarf/50 focus-within:shadow-[0_0_24px_-6px_rgba(169,200,255,0.45)]"
    >
